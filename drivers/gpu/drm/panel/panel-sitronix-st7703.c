...
static void fut0500hd_init_sequence(struct mipi_dsi_multi_context *dsi_ctx)
{
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETEXTC ,0xF1 ,0x12 ,0x83);


	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETMIPI ,0x31 ,0x81 ,0x05 ,0xF9 ,0x0E  ,0x0E ,0x20 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x44 ,0x25 ,0x00 ,0x91 ,0x0A ,0x00 ,0x00 ,0x02 ,0x4F ,0xD1 ,0x00 ,0x00 ,0x37 );

	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETPOWER_EXT ,0x25);


	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_UNKNOWN_BF ,0x02 ,0x10 ,0x00);


	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETRGBIF ,0x07 ,0x0B ,0x1E ,0x1E ,0x03 ,0xFF ,0x00 ,0x00 ,0x00 ,0x00);

	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETSCR ,0x73 ,0x73 ,0x50 ,0x50 ,0x00 ,0x00 ,0x08 ,0x70 ,0x00);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETDISP ,0xC8 ,0x12);

	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETEQ ,0x0 ,0x07 ,0x0B ,0x0B ,0x03 ,0x0B ,0x00 ,0x00 ,0x00 ,0x00 ,0xFF ,0x80 ,0xC0 ,0x14);



	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETPOWER ,0x53 ,0x00 ,0x1E ,0x1E ,0x77 ,0xF1);


	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETBGP ,0x09 ,0x09);


	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETVCOM ,0xB7 ,0xB7);


	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETGIP1 ,0xC2 ,0x10 ,0x09 ,0x00 ,0x00 ,0x08 ,0xEA ,0x12 ,0x30 ,0x00 ,0x27 ,0x85 ,0x08 ,0xEA ,0x27 ,0x18 ,0x00 ,0x05 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x05 ,0x00 ,0x00 ,0x00 ,0x00 ,0xF8 ,0xBA ,0x46 ,0x02 ,0x08 ,0x28 ,0x88 ,0x88 ,0x88 ,0x88 ,0x88 ,0xF8 ,0xBA ,0x57 ,0x13 ,0x18 ,0x38 ,0x88 ,0x88 ,0x88 ,0x88 ,0x88 ,0x00 ,0x00 ,0x00 ,0x03 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00);


	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETGIP2 ,0x07 ,0x12 ,0x01 ,0x01 ,0x02 ,0x3C ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x8F ,0xBA ,0x31 ,0x75 ,0x38 ,0x18 ,0x88 ,0x88 ,0x88 ,0x88 ,0x88 ,0x8F ,0xBA ,0x20 ,0x64 ,0x28 ,0x08 ,0x88 ,0x88 ,0x88 ,0x88 ,0x88 ,0x23 ,0x10 ,0x00 ,0x00 ,0x04 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00);

	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETGAMMA ,0x00 ,0x05 ,0x09 ,0x15 ,0x0F ,0x3F ,0x2F ,0x2D ,0x05 ,0x0A ,0x0C ,0x11 ,0x13 ,0x10 ,0x10 ,0x1C ,0x1F ,0x00 ,0x03 ,0x03 ,0x17 ,0x11 ,0x3F ,0x2F ,0x2D ,0x05 ,0x08 ,0x0E ,0x0F ,0x13 ,0x12 ,0x16 ,0x18 ,0x1D);


	mipi_dsi_msleep(dsi_ctx, 800);
}

static const struct drm_display_mode fut0500hd_mode = {
	.hdisplay	= 720,
	.hsync_start	= 720 + 30,
	.hsync_end	= 720 + 30 + 30,
	.htotal		= 720 + 30 + 30 + 40,
...
static const struct st7703_panel_desc fut0500hd_panel_desc = {
	.mode = &fut0500hd_mode,
	.lanes = 2,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_LPM,
	.format = MIPI_DSI_FMT_RGB888,
	.init_sequence = fut0500hd_init_sequence,
};
...
static const struct of_device_id st7703_of_match[] = {
	...
	{ .compatible = "futureelectronics,fut0500hd", .data = &fut0500hd_panel_desc },
	{ /* sentinel */ }
};
